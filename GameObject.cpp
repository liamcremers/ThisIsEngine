...
void dae::GameObject::SetParent(GameObject* pParent, bool keepWorldPostion)
{
	...
	m_KeepWorldPosition= keepWorldPostion;
	SetPositionDirty();
}
...
void dae::GameObject::SetLocalPosition(const glm::vec2& position) const
{
